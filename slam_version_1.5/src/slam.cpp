...
int main( int argc, char** argv )
{
    ...
    *******************************/
    ...
    globalOptimizer.save("../result/g2o/result_before.g2o");
    globalOptimizer.initializeOptimization();
    globalOptimizer.optimize( 100 ); //可以指定优化步数
    globalOptimizer.save( "../result/g2o/result_after.g2o" );
    ...
    voxel.filter( *tmp );
    //存储
    pcl::io::savePCDFile( "../result/pcd/result.pcd", *tmp );
...
FRAME readFrame( int index, ParameterReader& pd )
{
    ...
    string tum_dataset_path = pd.getData("tum_dataset_path");
    string associate_path = tum_dataset_path + "associate.txt";
    ...
    else if (use_tum == "yes")
    {
        ...
        f.rgb = cv::imread( tum_dataset_path + rgb_file );
        f.depth = cv::imread((tum_dataset_path + depth_file) , -1);
        f.frameID = index;
    }
